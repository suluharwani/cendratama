...
$('#tabel_serverside').on('click','.aktifkanstatus',function(){
  ...
  $.ajax({
    type : "POST",
    url  : base_url+"admin/ubah_status_user",
    async : false,
...
function valueChecked(a){
  if (a == 1) {
    ...
    $('#valueChecked').html("Dosen");
  }else if (a == 4) {
    $('#valueChecked').html("Karyawan");
  }else if (a == 5) {
    $('#valueChecked').html("Mahasiswa");
  }else{
    $('#valueChecked').html("");
  }
...
$('#tabel_serverside').on('click','.ubah_level_user',function(){
  ...
  Swal.fire({
    ...
    <input type="radio" name="options" onclick="valueChecked(3)"  value = "3" class = "level_user"  autocomplete="off"> Dosen
    </label>
    &nbsp;
    <label class="btn btn-danger">
    <input type="radio" name="options" onclick="valueChecked(4)"  value = "4" class = "level_user"  autocomplete="off"> Karyawan
    </label>
    </div>
    <div>
    ...
    $.ajax({
      type : "POST",
      url  : base_url+'/admin/ubah_level_user',
      async : false,
      // dataType : "JSON",
